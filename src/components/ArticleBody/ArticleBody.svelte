...
<GridRow variant={"inline"}>
    <p class="!font-publico-headline-roman font-regular leading-heading-extra-tight text-[1.6rem] md:max-w-[520px] xs:max-w-[410px] text-text-primary md:text-left xs:text-left xs:pb-4 pt-4">How Minneapolis’ response to the immigration crackdown forged a new national identity.</p>
  ...
  <span class="!text-[#666666]  !text-[.75rem] tracking-[1px] rt-Text font-utility-label-reg-caps-03 text-text-secondary mb-8">March 2, 2026</span>
  </GridRow>
